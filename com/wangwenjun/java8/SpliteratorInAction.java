    ...
    static class MySpliteratorText {
        ...
        private class MySpliterator implements Spliterator<String> {
            ...
            public Spliterator<String> trySplit() {
                ...
                /*将前半部分分出去，后半部分保留在当前老对象中*/
                int left = start; //要分出去那部分的开始索引
                int right = start + mid; //要分出去那部分的结束索引
                start = start + mid + 1; //当前Spliterator对象的开始索引，当然它的结束索引不用修改，就是end
